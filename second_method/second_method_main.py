...
import pandas as pd
from second_method import (second_method_parsing, second_method_function_transformation, second_method_nnf,
                          second_method_enf, second_method_propagators, second_method_generate)
